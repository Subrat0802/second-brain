...
const SectionOneCard = ({icon: Icon, title, description}: SectionProps) => {
  return (
    <div className="w-[22%] bg-white dark:bg-transparent border rounded-xl py-10 px-3 flex shadow-md flex-col gap-3 font-inter border-[#ebe7e7] dark:border-[#111624] ">
