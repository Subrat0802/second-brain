    ...
    >
      <div className="flex justify-center flex-col items-center pt-10">
        ...
        <div className="flex justify-start  w-full gap-2 mt-8 flex-col text-sm " >
            <p>Quick Actions</p>
            <div className="flex text-white/50 bg-[#0F141B] p-2 rounded-lg justify-start items-center gap-1"><Plus width={15} /> Add New Items</div>
            <div className="flex text-white/50 bg-[#0F141B] p-2 rounded-lg justify-start items-center gap-1"><Plus width={15} /> Create Collections</div>
            <div className="flex text-white/50 bg-[#0F141B] p-2 rounded-lg justify-start items-center gap-1"><Plus width={15} /> Upload Files</div>
          </div>
      </div>
    </div>
  );
