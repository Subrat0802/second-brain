...
const varientSize = {
    "primary": "p-2 px-4 flex justify-center items-center gap-x-2 font-medium rounded-lg bg-[#080C13] text-white/80 dark:text-[#7F7F7F] dark:border border-[#7F7F7F] flex hover:bg-[#020305] hover:text-gray-100 transition-all duration-200 dark:hover:bg-[#090e16] dark:hover:border-[#c5c5c5] dark:hover:text-[#c5c5c5] transition-all duration-200",

    "secondary": "p-3 px-9 flex justify-center items-center gap-x-2 font-medium rounded-lg bg-[#080C13] text-white/80 dark:text-[#7F7F7F] text-lg dark:border dark:border-[#7F7F7F] flex hover:bg-[#020305] hover:text-gray-300 transition-all duration-200 dark:hover:bg-[#090e16] dark:hover:border-[#c5c5c5] dark:hover:text-[#c5c5c5] transition-all duration-200",

    "tertiary": "p-3 px-9 flex justify-center text-lg items-center gap-x-2 font-medium rounded-lg text- border-2 border-gray-300 text-[#080C13] dark:text-[#7F7F7F] dark:border dark:border dark:border-[#7F7F7F] flex dark:hover:bg-[#090e16] dark:hover:border-[#c5c5c5] dark:hover:text-[#c5c5c5] transition-all duration-200"
}
