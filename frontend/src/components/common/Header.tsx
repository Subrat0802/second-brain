...
const Header = () => {
  return (
    <div className="h-[9vh] dark:border-b-2 dark:border-[#111827] px-3 md:px-0">
      <div className="max-w-7xl  h-full mx-auto flex justify-between items-center font-inter  text-[#111827] dark:text-[#7F7F7F] py-2 ">
        <div className="flex justify-center gap-2 items-center ">
          ...
          <p className="text-2xl md:text-3xl font-medium  tracking-tight">SecondBrain</p>
        </div>
        ...
        <div className="text-2xl md:hidden block"><Menu className="w-8 h-8"/></div>
      </div>
    </div>
  );
};
